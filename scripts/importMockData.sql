...
INSERT INTO `toasttagging`.`user` (admin, username, password)
	VALUES (1, "admin", "$2a$10$K1.o08GE0/RSGLoh0QFWW.LrISRHBJQyNB6WbwSWqu/AP788OXUhm"),
		   (0, "miles", "$2a$10$aEyN0Yt6tqQJvCfDdFfSKOx2j2Gus636Hhc8262UxrYu4sgJg6ih2"),
           (0, "billymays", "$2a$10$IhCW7eZ5rQlwlO7MQItT4u9EhRGwqwiKZBdvvJknOpjcQaG6ZqA3S"),
           (0, "client1", "$2a$10$Gz37yc/hZxDJM8f6t2gTneusBrbwHsO/Sw3Yy0K5JgVGLQbN/pTSe"),
           (0, "client2", "$2a$10$JhSY8fy0NiQaryUkzaerc.8OpcaHL4KoWDbKkrvq/in5pvj/dCj0G"),
           (0, "client3", "$2a$10$sm3k58cUeVABL/1JGhbV4etvw0BhrNmZ1ggKncvgD5gKudLuFd0wS"),
           (0, "tommy.wiseau", "$2a$10$s4dLIpDf9BF8eQuYXz438uxMn7se7jW12K6s0n5LWnH9nq8pFSlga");
